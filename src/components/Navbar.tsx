...
export default function Merch() {
    return (
        <section className='merchBackground'>
            <Navbar />
            {/*
             * pt-20 = kompensasi Navbar fixed h-20 (80px)
             * Tanpa ini, hero section dimulai dari top: 0
             * dan tertutup oleh Navbar yang fixed
             */}
            <main className='relative overflow-x-hidden pt-20'>

                {/* ── HERO SECTION ── */}
                <section className='relative w-full min-h-[calc(100dvh-5rem)] flex items-center justify-center overflow-hidden bg-transparent'>
                    ...
                    {/* Top-left: Mask */}
                    <div className='pointer-events-none absolute z-10 top-[12%] left-[3%] sm:top-[16%] sm:left-[6%] lg:top-[20%] lg:left-[10%]'>
                        <Image
                            src='/about/mask.webp'
                            alt='Mask decoration'
                            width={100}
                            ...
                            priority
                            quality={100}
                            className='w-9 sm:w-14 md:w-16 lg:w-20 xl:w-24 h-auto'
                        />
                    </div>

                    {/* Top-right: Trumpet */}
                    <div className='pointer-events-none absolute z-10 top-[8%] right-[3%] sm:top-[12%] sm:right-[6%] lg:top-[14%] lg:right-[10%]'>
                        <Image
                    ...
                    <div className='pointer-events-none absolute z-10 bottom-[14%] left-[3%] sm:bottom-[18%] sm:left-[6%] lg:bottom-[22%] lg:left-[10%]'>
                        <Image
                    ...
                    {/* Bottom-right: Crown */}
                    <div className='pointer-events-none absolute z-10 bottom-[10%] right-[3%] sm:bottom-[16%] sm:right-[6%] lg:bottom-[18%] lg:right-[10%]'>
                        <Image
                    ...
                    {/* Hero Content */}
                    <div className='relative z-10 text-center w-full max-w-5xl mx-auto px-16 sm:px-20 md:px-24 lg:px-16'>
                        <div className='flex flex-wrap items-center justify-center gap-2 sm:gap-3 md:gap-4'>
                            <span className='font-westmeath text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-white font-bold leading-tight'>
                                OUR
                            </span>
                            <Image
                                ...
                                priority
                                quality={100}
                                className='w-6 sm:w-8 md:w-9 h-auto'
                        ...
                        <p className='font-raleway text-xs sm:text-base md:text-lg lg:text-xl text-white/80 max-w-2xl mx-auto mt-3 sm:mt-5 md:mt-6 leading-relaxed'>
