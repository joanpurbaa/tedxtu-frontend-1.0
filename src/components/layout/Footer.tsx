            ...
            <div className='max-w-7xl mx-auto'>
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12'>
                    ...
                    <div className='flex flex-col items-start gap-6'>
                        <div className='w-48 h-auto -ms-3'>
                            <Image
                                src='/logo-white.svg'
                    ...
                    <div className='flex flex-col gap-6'>
                        <h3 className='font-westmeath text-xl sm:text-2xl font-bold'>
                            QUICK LINKS
                        </h3>
                        <nav className='flex flex-col gap-3'>
                            <Link
                                href='/'
                                className='font-raleway text-sm sm:text-base text-white/80 hover:text-red-500 transition-colors'
                            >
                                Home
                            </Link>
                            <Link
                    ...
                    <div className='flex flex-col gap-6'>
                        ...
                        <div className='flex flex-col gap-4'>
                            ...
                            <a
                                href='mailto:tedxtelkomuniversity@gmail.com'
                    ...
                    <div className='flex flex-col gap-6'>
                        ...
                        <div className='flex gap-4'>
                            <a
                                href='https://www.instagram.com/tedxtelkomuniversity'
                                target='_blank'
