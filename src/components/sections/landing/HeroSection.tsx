...
export function HeroSection() {
    ...
    const rawBottomRightY = useTransform(
        scrollYProgress,
        [0, 1],
        ['0%', '50%'],
    );
        ...
        >
            ...
            >
                <Image
                    ...
                    priority
                    quality={75}
                    className='w-16 md:w-28 lg:w-32 -mt-10 ms:mt-0'
                />
            </motion.div>
            ...
            >
                <Image
                    ...
                    priority
                    quality={75}
                    className='w-12 md:w-28 lg:w-32 -mt-10 ms:mt-0'
                />
            </motion.div>
            ...
            <motion.div
                ...
                style={{
                    y: bottomLeftY,
                    x: bottomLeftX,
                    rotate: bottomLeftRot,
                }}
                className='absolute bottom-[10%] left-[15%] md:bottom-1/4 md:left-1/4 -translate-x-1/2 translate-y-1/2 z-10 pointer-events-none'
            >
                <Image
                    ...
                    priority
                    quality={75}
                    className='w-16 md:w-28 lg:w-32 mt-20 ms:mt-0 -rotate-12'
                />
            </motion.div>
            ...
            <motion.div
                ...
                style={{
                    y: bottomRightY,
                    x: bottomRightX,
                    rotate: bottomRightRot,
                }}
                className='absolute bottom-[10%] right-[15%] md:bottom-1/4 md:right-1/4 translate-x-1/2 translate-y-1/2 z-10 pointer-events-none'
            >
                <Image
