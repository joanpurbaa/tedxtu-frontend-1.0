...
const faqData: FaqItem[] = [
    {
        question: 'APA ITU TEDxTELKOM UNIVERSITY?',
        answer: 'TEDxTelkom University adalah sebuah organisasi yang didirikan oleh mahasiswa Telkom University untuk berbagi ide-ide inovatif dan inspiratif melalui format TEDx.',
    },
    {
...
const formatQuestion = (text: string) => {
    return text
        ...
        .join(' ')
        .replace(/Tedxtelkom University/gi, 'TEDxTelkom University')
        .replace(/Tedx/gi, 'TEDx');
};
...
const FaqCard = ({
    ...
    return (
        ...
        >
            ...
            <div
                className={`relative z-10 px-8 md:px-12 lg:px-16 transition-all duration-500 ${isOpen ? 'py-10' : 'py-5'}`}
            >
                <div className='flex items-center justify-between gap-6'>
                    <h3 className='text-lg md:text-xl font-normal text-white tracking-wider leading-tight font-westmeath'>
