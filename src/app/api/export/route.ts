...
export async function GET() {
    ...
    const rows = tickets.map((t) => ({
        ...
        'Music is a big part of daily life': t.musicLifestyle ? 'Yes' : 'No',
        'Environment shapes who you are': t.environmentShapes ? 'Yes' : 'No',
        'Emotions expressed through arts': t.artsExpression ? 'Yes' : 'No',
