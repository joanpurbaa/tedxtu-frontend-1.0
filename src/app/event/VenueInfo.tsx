			...
			<div className="relative mx-auto max-w-6xl">
				<div className="mx-auto max-w-2xl text-center">
					...
					<p className="mt-3 font-raleway text-sm text-white/70 sm:text-base">
						Get ready to experience the Main Event TEDxTelkom University
					</p>
				</div>
				...
				<div className="mt-10 grid gap-8 lg:grid-cols-2 lg:items-center">
					...
					<div className="space-y-6 font-raleway">
						<div className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-white/70">
									Jl. BKR No.185, Cijagra, Kec. Lengkong, Kota Bandung, Jawa Barat 40265
								</p>
							</div>
						</div>
						...
						<div className="flex items-start gap-3">
							...
							<div>
								<p className="font-semibold text-white">Open Gate:</p>
						...
						<div className="flex items-start gap-3">
							...
							<div>
								...
								<p className="text-white/70">September 15, 2026</p>
							</div>
						</div>

						<a
							href="https://maps.google.com/?q=Sri+Baduga+Museum"
							target="_blank"
